...
@section('title', 'Edit Program Studi - Panel Admin')
...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between pb-4 border-b border-slate-200">
        <div>
            <h1 class="text-2xl font-bold tracking-tight text-slate-900">Edit Program Studi</h1>
            <p class="text-slate-500 text-sm font-medium">Ubah nama program studi dan perbarui nominal ke-7 komponen biaya wajib.</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="ukt" id="ukt" value="{{ old('ukt', $prodi->ukt) }}" min="0" required
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-slate-400 font-bold text-xs">Rp</span>
                            <input type="number" name="dpi" id="dpi" value="{{ old('dpi', $prodi->dpi) }}" min="0" required
                                class="block w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 bg-white text-slate-900 font-medium text-sm transition-all outline-none">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-slate-400 font-bold text-xs">Rp</span>
                            <input type="number" name="seragam" id="seragam" value="{{ old('seragam', $prodi->seragam) }}" min="0" required
                                class="block w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 bg-white text-slate-900 font-medium text-sm transition-all outline-none">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-slate-400 font-bold text-xs">Rp</span>
                            <input type="number" name="atribut" id="atribut" value="{{ old('atribut', $prodi->atribut) }}" min="0" required
                                class="block w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 bg-white text-slate-900 font-medium text-sm transition-all outline-none">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-slate-400 font-bold text-xs">Rp</span>
                            <input type="number" name="pkl" id="pkl" value="{{ old('pkl', $prodi->pkl) }}" min="0" required
                                class="block w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 bg-white text-slate-900 font-medium text-sm transition-all outline-none">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-slate-400 font-bold text-xs">Rp</span>
                            <input type="number" name="ta" id="ta" value="{{ old('ta', $prodi->ta) }}" min="0" required
                                class="block w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 bg-white text-slate-900 font-medium text-sm transition-all outline-none">
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-slate-400 font-bold text-xs">Rp</span>
                            <input type="number" name="wisuda" id="wisuda" value="{{ old('wisuda', $prodi->wisuda) }}" min="0" required
                                class="block w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 bg-white text-slate-900 font-medium text-sm transition-all outline-none">
                        </div>
                    </div>
                </div>
